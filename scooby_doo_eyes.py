...
def main() :
    ...
    while True:
    	...
    	blackFrame = np.zeros(frame.shape, frame.dtype)
    	...
    	for rect in rects:
    		...
    		# threshold
    			...
    			if COUNTER >= EYE_AR_CONSEC_FRAMES:
    				...
    				cv2.drawContours(blackFrame, [leftEye], -1, (107, 235, 242), cv2.FILLED)
    				cv2.drawContours(blackFrame, [rightEye], -1, (107, 235, 242), cv2.FILLED)
    	...
    	mirrorImage = cv2.flip(blackFrame, 1)
    	# show the frame
